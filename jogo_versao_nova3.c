...
while(fase<4){
	...
	if(pontos==120){fase = 2;if(fase == 2|| fase == 3){for(f=0;f<20;f++){for(g=0;g<20;g++){m[f][g] = '.';}}}}
	if(pontos==240){fase = 3;if(fase == 2|| fase == 3){for(f=0;f<20;f++){for(g=0;g<20;g++){m[f][g] = '.';}}}}
	if(pontos==360){win();fase = 4;if(fase == 2|| fase == 3){for(f=0;f<20;f++){for(g=0;g<20;g++){m[f][g] = '.';}}}}
